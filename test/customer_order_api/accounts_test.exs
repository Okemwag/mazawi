defmodule CustomerOrderApi.AccountsTest do
  use CustomerOrderApi.DataCase

  alias CustomerOrderApi.Accounts

  describe "customers" do
    alias CustomerOrderApi.Accounts.Customer

    import CustomerOrderApi.AccountsFixtures
